...
class BulkExportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              onPressed: () async {
                ...
                await product.getProducts().then((value) async {
                  for (final item in value) {
                    final currItem = item.toMap();
                    stringToWrite = '$stringToWrite${currItem['name']}, ${currItem['price']}, ${DateTime.parse(currItem['purchaseDate'].toString())}, ${currItem['warrantyPeriod']}, ${currItem['company']}, ${currItem['category']}, ${currItem['purchasedAt']}, ${currItem['salesPerson']}, ${currItem['phone']}, ${currItem['email']}, ${currItem['notes']}, \n';
                  }
                });
      ...
      bottomNavigationBar: const BulkActionScreen(currentIndex: 1),
    );
  }
}
